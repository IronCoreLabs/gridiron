...
mod lib {
    ...
    fn mont_mult1() {
        ...
        let expected = fp31_480::Fp480::new([
            1156770836, 348200834, 264281010, 1142066344, 1260443462, 2075079410, 1954696512,
            1580140093, 1893133622, 474483382, 1848885502, 1610043293, 157645373, 1244359076,
            730943304, 2490,
        ]);
    ...
    fn mont_mult2() {
        ...
        // a * R % fp_256::PRIME = 4971751050326723978098995808477473392532700477904943491440378568776508574646
        let expected = fp31_256::Fp256::new([
            647564214, 963458076, 1019830536, 251074318, 1016337447, 182157637, 1535281306,
            2129962976, 10,
        ]);
    ...
    fn mont_mult3() {
        ...
        let a = fp31_256::Fp256::new([1u32; fp31_256::NUMLIMBS]);
        let expected = fp31_256::Fp256::new([
            504829575, 531024141, 28653343, 1438292993, 1171467083, 706614445, 1908070472,
            229228933, 40,
        ]);
        assert_eq!((a.to_monty() * a.to_monty()).to_norm(), expected);
    }
