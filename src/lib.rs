...
mod lib {
 ...
 //        let result = fp_256::Fp256::new([788810548,
 // 408726636,
 // 1097558844,
 // 963519300,
 // 203874575,
 ...
 // 71]);
 // 
 let result = fp_256::Fp256::new([788810548,408726636,1097558844,963519300,203874575,654232454,1416691509,1832941778,71]);
        //41389210591178563197866013531977652355280622370776165812970320099896695112225
    ...
    fn static_co_reduce_256_bit() {
        let a_result = [2102762755, 340721811, 1526670465, 1233221938, 1621045422, 3878, 0, 0, 0];
        let b_result = [496048871, 1583721686, 351053136, 72635571,14163922, 1245, 0, 0, 0];
        let mut a = [2003540029, 1136642599, 2013451521, 1081750855, 2108178975, 1491192821, 4, 0, 0];
        let mut b = [2089475485, 1450247307, 1692152066, 1263335112, 856386648, 2075289019, 25, 0, 0];
        let pa = 6648347;
        let pb = -1201787;
        let qa = -12242368;
        let qb = 2213312;
